...
public class Problem_879 {
    ...
    public int profitableSchemes(int n, int minProfit, int[] group, int[] profit) {
        ...
        dp[0][0][0] = 1;
        for (int i = 1; i <= m; i++) {
            int members = group[i - 1], pro = profit[i - 1];
            for (int j = 0; j <= n; j++) {
    ...
    public static void main(String[] args) {
        ...
        int[] group = new int[]{2, 3, 5}, profit = new int[]{6, 7, 8};
        System.out.println(new Problem_879().profitableSchemes(n, minProfit, group, profit));
    }
}
