...
public class Problem_1744 {
    public boolean[] canEat(int[] candiesCount, int[][] queries) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            int daCap = queries[i][2];
            long earlyEat = favDay + 1;
            long lateEat = (long)daCap * (favDay + 1);
            long earlyCandy = favType == 0?1:sum[favType - 1] + 1;
            long lateCandy = sum[favType];
            ans[i] = lateCandy >= earlyEat && lateEat >= earlyCandy;
        }
        return ans;
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new Problem_1744().canEat(new int[]{16,38,8,41,30,31,14,45,3,2,24,23,38,30,31,17,35,4,9,42,28,18,37,18,14,46,11,13,19,3,5,39,24,48,20,29,4,19,36,11,28,49,38,16,23,24,4,22,29,35,45,38,37,40,2,37,8,41,33,8,40,27,13,4,33,5,8,14,19,35,31,8,8}, new int[][]{{43,1054,49}})));
